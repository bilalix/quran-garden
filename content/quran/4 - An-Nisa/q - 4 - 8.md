...
[^1]: For example, in the case of orphaned children whose grandfather then dies, leaving behind other children, some scholars rule that an obligatory bequest should be made to them despite not having a share in inheritance.
